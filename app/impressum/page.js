const Impressum = () => {
	return (
		<section className="impressum-page container mx-auto px-4 py-8 max-w-4xl">
			...
			<p className="mb-6">
				E-Mail: info@andreas-zipfel.de
			</p>


			<h2 className="text-2xl font-bold mb-4">Verantwortlich für den Inhalt nach Paragraph 55 Absatz 2 RStV</h2>
			<p className="mb-6">
				Andreas Zipfel<br />
				79111 Freiburg<br />
				Deutschland
			...
			<p className="mb-4">
				Als Diensteanbieter sind wir gemäss Paragraph 7 Absatz 1 TMG für eigene Inhalte auf diesen
				Seiten nach den allgemeinen Gesetzen verantwortlich. Nach Paragraphen 8 bis 10 TMG sind wir als
