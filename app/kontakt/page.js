...
export default function Kontakt() {
	return (
		<>
			<div className="container mx-auto max-w-4xl mb-10 rounded-(--border-radius-md) bg-(--background-light) px-6 py-10 shadow-(--box-shadow-light)">
				<h1 className="text-3xl">📢 Deine Fragen, Ideen & Feedback</h1>

				<p className="my-4">Hast du eine <strong>geniale Rezept-Idee</strong>, die wir unbedingt auf unserer Seite veröffentlichen sollten? Möchtest du uns <strong>Feedback</strong> geben oder hast du eine Frage zum Projekt? Oder vielleicht eine <strong>Zusammenarbeit</strong> mit uns im Sinn?</p>

				<p className="my-4">Wir freuen uns über jeden Kontakt und versuchen, so schnell wie möglich zu antworten. Hier findest du alle Möglichkeiten, uns zu erreichen:</p>
				...
				<div className="contact-method my-6">
					...
					<p className="my-2"><strong>👉 <a href="" onClick={(e)=>{alert('Tut mir leid. Der Teilnehmer ist momentan nicht erreichbar')}}>kontakt@rezepte-iota.de</a></strong></p>
					<p className="my-2">Wir ignorieren deine Antwort 24/7</p>
				</div>

				<div className="contact-method my-6">
					<h2 className="text-2xl">💬 Kontaktformular</h2>
					<p className="my-4">Nutze einfach unser <strong>unteres Kontaktformular</strong>, um uns eine Nachricht zu schicken. Gib uns gerne so viele Details wie möglich – wir freuen uns über jedes Feedback!</p>
				</div>
				...
				<div className="tip my-6">💡 <strong>Tipp:</strong> Falls du ein Rezept einreichen möchtest, nutze am besten unser <a href="#contact-form"><strong>Rezept-Formular</strong></a> oder schick uns eine E-Mail mit:
					<ul>
